...
import { Bot, ChevronDown, MessageCircleMore, Send, Sparkles, X } from 'lucide-react';
import { Link } from 'react-router-dom';

const STORAGE_KEY = 'tdphone-support-chat';
...
const createReply = (message) => {
  ...
  if (text.includes('giá') || text.includes('gia') || text.includes('rẻ') || text.includes('re') || text.includes('ngân sách') || text.includes('ngan sach')) {
    return {
